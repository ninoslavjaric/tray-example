...
public class ColorPicker extends javax.swing.JDialog {
     ...
     */
    public ColorPicker(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Color chosenOne = jColorChooser1.getColor();
        ConfigDashboardHolder.setBgColor(chosenOne);
        Dashboard parent = (Dashboard) this.getParent();
        parent.setLabelColor(chosenOne);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ColorPicker dialog = new ColorPicker(new javax.swing.JFrame(), true);
